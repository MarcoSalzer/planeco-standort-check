...
| 6 | `geocode_status = 'mehrdeutig'` | 🟡 | "Adresse mehrdeutig: {n} mögliche Orte — im Gespräch klären" |
| 7 | `phone_e164 IS NULL` (kein Telefon angegeben) | 🟡 | "Nur per E-Mail erreichbar" |
| 8 | `phone_valid = false` | 🟡 | "Telefonnummer nicht lesbar: {phone_raw}" |
| 9 | `postal_code IS NULL` | 🟡 | "Keine PLZ angegeben — Ort per Geocoding bestätigt" |
| 10 | sonst | 🟢 | "Vollständig" |
...
behandeln, sondern kurz später erneut schauen.
