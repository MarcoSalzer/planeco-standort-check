...
def _apply_geocode_result(conn: psycopg.Connection, lead_id: str, result: GeocodeResult) -> None:
    conn.execute(
        ...
        SET geocode_status = %(status)s,
            ...
            geo_country = %(geo_country)s, geo_postal_code = %(geo_postal_code)s, geocode_raw = %(geocode_raw)s,
        ...
        """,
        {
            ...
            "geo_country": result.geo_country, "geo_postal_code": result.geo_postal_code,
